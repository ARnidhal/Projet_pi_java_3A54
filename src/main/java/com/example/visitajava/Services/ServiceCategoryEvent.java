package com.example.visitajava.Services;

import com.example.visitajava.Entity.CategoryEvent;
import com.example.visitajava.Interface.IService;
import com.example.visitajava.Utils.DataBase;
import com.example.visitajava.controllers.AfficherCategoryBackControllers;
...
public class ServiceCategoryEvent implements IService<CategoryEvent> {
    ...
    public void changeScreen(ActionEvent event, String s, String clientFront) {
        try {
            FXMLLoader loader = new FXMLLoader(AfficherCategoryBackControllers.class.getResource(s));
            Parent root = loader.load();
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            stage.setTitle(clientFront);
