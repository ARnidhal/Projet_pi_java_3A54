...
public class AddEventController {
    ...
    private boolean validateInput() {
        if (addEvent_NAME.getText().isEmpty() ||
                addEvent_lieu.getText().isEmpty() ||
                addEvent_DATE.getValue() == null ||
                addEvent_DATE1.getValue() == null ||
                addEvent_type.getText().isEmpty() ||
                addEvent_nbrParticipant.getText().isEmpty() ||
                addEvent_CATEGORY.getValue() == null) {
            return false;
        }
        return true;
    }
    ...
    void categorypage(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/visitajava/AddCategory.fxml"));
