...
import com.example.visitajava.Entity.Participation;
import com.example.visitajava.Entity.react;
import com.example.visitajava.Services.EmailSender;
import com.example.visitajava.Services.ParticipationServiceImpl;
import com.example.visitajava.Services.ReactServiceImpl;
import com.example.visitajava.Utils.DataBase;
...
public class EventFrontController {
    ...
    ParticipationServiceImpl participationService = new ParticipationServiceImpl(DataBase.getInstance().getCnx());
    private ReactServiceImpl reactService = new ReactServiceImpl(DataBase.getInstance().getCnx());
    ...
    public void setData(Evenement evenement) {
        ...
        File file = new File(evenement.getImage_evenement());
