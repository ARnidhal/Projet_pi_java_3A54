...
public class AddService {
    ...
    public void initialize() {
        ...
        TableView.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> {
            ...
            if (newValue != null) {
                ...
                // Si l'image est disponible, affichez-la
                if (newValue.getImage() != null && !newValue.getImage().isEmpty()) {
        ...
        addService_col_CATEGORY.setCellValueFactory(new PropertyValueFactory<Service, String>("category_nom")); // Assurez-vous que le modèle a une méthode `getCategoryName`
    ...
    void modifierService(ActionEvent event) {
        ...
        if (imagePath != null && !imagePath.isEmpty()) {
            selectedService.setImage(imagePath);
        }
