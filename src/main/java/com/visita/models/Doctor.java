...
public class Doctor extends User
{
    ...
    public Doctor(int id, String username, String email, String phone, String password, String token, String photo, int code, String[] role, String fullname, String specialite, String adress) {
